...
use Klickmanufaktur\StatamicUmamiAnalytics\Http\Requests\AnalyticsRequest;
...
{
    public function __invoke(AnalyticsRequest $request, AnalyticsData $analytics, UmamiClient $client): JsonResponse
    {
        ...
        try {
            return response()->json([
                'configured' => true,
                ...$analytics->overview($request->days()),
            ]);
